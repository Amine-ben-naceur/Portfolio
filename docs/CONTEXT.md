...
**Owner:** Mohamed Amine Ben Naceur · **Repo:** `rocketwebsite` · **Live:** https://www.mohamedaminebennaceur.com (placeholder — update once deployed)
...
change what the site says). Mohamed Amine Ben Naceur — Développeur Logiciel Full
Stack, based in Bizerte, Tunisia.

- **Now:** Full-Stack Developer @ **2As Project** (Nov 2025 – present). Web apps
  with React/Node.js/PostgreSQL, a React Native + Firebase mobile app, and VoIP
  features (WebRTC, SIP.js, Asterisk).
- **Before:** Frontend & VoIP Developer, PFE intern @ **2As Project** (Feb–Apr
  2025) — CRM platform, a SIP/VoIP web dialer, and early AI call-analysis
  modules. Also a network/telecom internship @ **Tunisie Telecom** (Jun 2024) —
  xDSL/Fibre install, maintenance, and diagnostics.
- **Education:** Licence in network & IT systems engineering — ISSAT Mateur
  (2022–2025); Baccalauréat in Computer Science — Lycée Jeune Fille Bizerte
  (2022); certified Cisco Ethical Hacking · Cisco Networking.
- **Contact:** `bennaceuramine063@gmail.com` · `+216 56 183 326` · GitHub
  `Amine-ben-naceur`. No LinkedIn/Medium provided — those links have been
  removed from the UI rather than left dangling.
- **Résumé:** served from `/public/Resume_MohamedAmineBenNaceur.pdf`.
...
- `PROJECTS: Project[]` — **three** projects, each with `colorA/colorB` gradient
...
- **`ProjectOrbit.tsx`** — the **interactive centerpiece**: the three project cards
...
- **`SectionOverlays.tsx`** — the five content panels, each shown by a scroll
  **envelope** (ramp in, hold, ramp out) tuned per section:
  ...
  - **02 Work** — right-side panel with **tabs** (one per EXPERIENCE entry — currently 2As Project / 2As Project PFE / Tunisie Telecom) and a scrollable bullet
...
- **Résumé** — `/public/Resume_MohamedAmineBenNaceur.pdf`.
...
public/
  textures/  hdri/  models/  Resume_MohamedAmineBenNaceur.pdf
docs/
